...
function buildQueryURL() {
    var queryURL = "https://api.openweathermap.org/data/2.5/forecast?&cnt=40&units=imperial&";
    // q={city name}&appid={API key}"


    // Begin building an object to contain our API call's query parameters
    // Set the API key
    var queryParams = { "appid": "bc3ff74ee9aee159e13710101f5f0ee7" };
...
function updatePage(cityData) {
    ...
    var uvQueryParams = { "appid": "bc3ff74ee9aee159e13710101f5f0ee7" };
    ...
    var iconUrl2 =
        "https://openweathermap.org/img/wn/" + cityData.list[8].weather[0].icon + "@2x.png";
    

    var dateEpochts2 = cityData.list[8].dt * 1000;
    ...
    $("#icon2").attr({
        src: iconUrl2,
        alt: cityData.list[8].weather[0].description,
    });
    // Text to be updated 
    $("#2ndDate").text(theDate2);
    $("#temp2").text("Temp: " + cityData.list[8].main.temp + "°");
    $("#humidity2").text("Humidity: " + cityData.list[8].main.humidity + "%");

    // Day 3 ------------------------------------------------------------------------------------------------

    var iconUrl3 =
        "https://openweathermap.org/img/wn/" + cityData.list[16].weather[0].icon + "@2x.png";


    var dateEpochts3 = cityData.list[16].dt * 1000;
    ...
    $("#icon3").attr({
        src: iconUrl3,
        alt: cityData.list[16].weather[0].description,
    });
    // Text to be updated 
    $("#3rdDate").text(theDate3);
    $("#temp3").text("Temp: " + cityData.list[16].main.temp + "°");
    $("#humidity3").text("Humidity: " + cityData.list[16].main.humidity + "%");

    // Day 4----------------------------------------------------------------------------------------------
    var iconUrl4 =
        "https://openweathermap.org/img/wn/" + cityData.list[24].weather[0].icon + "@2x.png";

    var dateEpochts4 = cityData.list[24].dt * 1000;
    ...
    $("#icon4").attr({
        src: iconUrl4,
        alt: cityData.list[24].weather[0].description,
    });
    // Text to be updated 
    $("#4thDate").text(theDate4);
    $("#temp4").text("Temp: " + cityData.list[24].main.temp + "°");
    $("#humidity4").text("Humidity: " + cityData.list[24].main.humidity + "%");
// Day 5-------------------------------------------------------------------------------------------------------

var iconUrl5 =
        "https://openweathermap.org/img/wn/" + cityData.list[32].weather[0].icon + "@2x.png";

    var dateEpochts5 = cityData.list[32].dt * 1000;
    ...
    $("#icon5").attr({
        src: iconUrl5,
        alt: cityData.list[32].weather[0].description,
    });
    // Text to be updated 
    $("#5thDate").text(theDate5);
    $("#temp5").text("Temp: " + cityData.list[32].main.temp + "°");
    $("#humidity5").text("Humidity: " + cityData.list[32].main.humidity + "%");
